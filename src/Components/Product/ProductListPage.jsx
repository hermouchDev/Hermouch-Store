                        ...
                        >
                            ...
                            >
                                <div className="position-relative">
                                    ...
                                    <span
                                        className="position-absolute top-0 end-0 m-1 m-md-2 m-lg-3 rounded-pill px-1 px-md-2 px-lg-3 py-1 small"
                                        style={{
                                            background:
                                ...
                                <div className="px-2 px-md-3 px-lg-4 py-2 py-md-3 py-lg-4">
                                    <div className="mb-2">
                                        <h2
                                            className="h6 fw-semibold text-capitalize mb-1"
                                            style={{
                                                fontSize:
                                ...
                                <div className="px-2 px-md-3 px-lg-4 pb-2 pb-md-3 pb-lg-4 mt-auto">
                                    <div className="d-flex gap-1 gap-md-2">
                                        <Link
                                            to={`/product/${product.id}`}
                                            className="btn btn-outline-secondary rounded-pill w-50 py-1 py-md-2 d-flex align-items-center justify-content-center text-decoration-none"
                                            style={{
                                                fontSize:
                                        ...
                                        <button
                                            type="button"
                                            className="btn btn-dark rounded-pill w-50 py-1 py-md-2"
                                            style={{
                                                fontSize:
                                                    "clamp(0.75rem, 2vw, 0.875rem)",
                                            }}
